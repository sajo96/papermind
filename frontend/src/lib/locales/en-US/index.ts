export const enUS = {
  ...
  sources: {
    ...
    allSourcesDesc: "View and manage all your sources here",
  ...
  annotations: {
    ...
    allCleared: "All annotations cleared",
  },
  pdfReader: {
    loading: "Loading PDF...",
    ...
    zoomOut: "Zoom out",
    clearAll: "Clear All",
    clearAllHint: "Delete all annotations for this PDF",
    clearAllTitle: "Clear all annotations?",
    clearAllDescription: "This will remove all annotations for this document. This action cannot be undone.",
